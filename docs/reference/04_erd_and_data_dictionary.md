...
## ملاحظة قاموس حاكمة — 2026-08-17

أي تعريف أو مثال قديم يذكر تقريب الربع أو milli-riyal
يُقرأ وفق ق-77:

- لا تقريب وقت.
- الوحدة ريال كامل.
- الحقول `_minor` أسماء تاريخية لكنها تحمل ريالًا كاملًا.
...
* التقريب إلى الربع الأعلى — ملغى.
* تقريب كل مصدر منفصلًا — ملغى.
* لا تقريب مالي؛ الوحدة المخزنة ريال كامل.
...
| المصدر | المدة الفعلية | المدة المحتسبة بلا تقريب | القيمة |
| ------ | --------------: | ----------: | -----: |
| الشمس  |              62 |          75 |  6,250 |
| الديزل |              31 |          45 |  8,000 |
