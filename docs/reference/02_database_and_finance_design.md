...
## ملاحظة حاكمة مالية بعد ق-77

الوحدة المالية النهائية للمشروع هي **ريال يمني كامل**.

أي شرح لاحق في هذه الوثيقة عن milli-riyal أو رصيد كسري
أصغر من الريال هو نص منسوخ بق-77 إذا لم يكن موسومًا تاريخيًا.

لا يوجد تقريب زمني، ولا يسمى سلوك باقي توزيع الأرباح
Largest Remainder Method؛ كامل الباقي يذهب لصاحب أكبر حصة.
...
> لا توجد قاعدة تقريب مالي؛ ق-77 جعل وحدة التخزين نفسها ريالًا كاملًا، دون إعادة تفعيل ceil_to_whole_yer.

بعد ق-77 لا تُخزن كسور الريال كوحدة مالية مستقلة؛ الحساب المالي النهائي يستخدم الريال الكامل.

مثال: 62 دقيقة بسعر 5,000 ريال للساعة = 5,166.666... ريال.

### القاعدة المعتمدة

تُخزَّن كل المبالغ كأعداد صحيحة BIGINT، ووحدتها **ريال يمني كامل** وفق ق-77.
...
لا توجد وحدة مالية مخزنة أصغر من ريال واحد بعد ق-77.
...
لا يوجد رصيد كسري مرحل أصغر من ريال بعد ق-77.
...
1. يحسب الوقت.
2. لا يطبق أي تقريب؛ تستخدم قواعد الوقت والمال الحالية.
3. تطبق الأسعار.
4. تطبق سياسة الشريك.
5. تنشأ مسودة فاتورة.
...
* التوقفات محفوظة.
* التقريب إلى الربع الأعلى — ملغى بق-12.
* الوقت الفعلي محفوظ.
...
1. سؤال نطاق التقريب حُسم نهائيًا: لا تقريب لأي مصدر ولا للجلسة.
