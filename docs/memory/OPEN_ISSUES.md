...
**الحالة:** مفتوحة — **ضُيِّقت مرتين:** 2026-08-22 بق-114 /
Migration 083+084 (الخادم)، و2026-08-23 بق-115 (طابور الجهاز)
**القرارات الحاكمة:** ق-89، ق-90، ق-114، ق-115
...
الحماية صارت موصولة من الطرفين، **لكن الإرسال يحتاج أن يكون
التطبيق مفتوحًا.** لا عامل خلفي، ولا استعادة تلقائية بعد
إقلاع الهاتف، ولا شاشة تعرض حالة المزامنة أو جاهزية الجهاز،
ولا واجهة ميدانية تُدخل العمليات أصلًا.

أي أن العملية المسجَّلة لم تبقَ معرَّضة للفقدان ولا للتكرار،
ويبقى أن تُرسل نفسها بلا انتظار أن يفتح المشغّل التطبيق.
