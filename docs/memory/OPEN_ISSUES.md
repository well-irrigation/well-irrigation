...
**ما بقي معلَّقًا في هذه الجولة:** التحقق المحلي (`db:reset` +
`db:test`) عند المالك، والمتوقع 31 files / 500 PASS. ودمج الهجرة في
`main` ينشرها على الإنتاج تلقائيًا، وأثرها هناك **توسيع اطلاع**: كل
مشغل ومدير مُعيَّن نشط يرى تسعيرة بئره بعد الدمج.
