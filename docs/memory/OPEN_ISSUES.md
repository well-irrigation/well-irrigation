...
**الحالة:** مفتوحة — **ضُيِّقت ثلاث مرات:** 2026-08-22 بق-114 /
Migration 083+084 (الخادم)، و2026-08-23 بق-115 (طابور الجهاز)،
و2026-08-23 بق-116 (سجل الجلسة النشطة والاستعادة)
**القرارات الحاكمة:** ق-89، ق-90، ق-114، ق-115، ق-116
...
**لكن الإرسال ما زال يحتاج أن يكون التطبيق مفتوحًا.** لا عامل
خلفي، ولا شاشة تعرض حالة المزامنة أو جاهزية الجهاز، ولا واجهة
ميدانية تُدخل العمليات أصلًا.

أي أن العملية المسجَّلة لم تبقَ معرَّضة للفقدان ولا للتكرار،
والجلسة لم تبقَ معرَّضة للضياع بموت التطبيق، ويبقى أن تُرسل
نفسها بلا انتظار أن يفتح المشغّل التطبيق.
...
- ~~reboot recovery~~ — **منفَّذة ومُثبتة على قرص حقيقي**
  (ق-116) لحالة الجلسة والزمن والدفعات. التشغيل التلقائي
  للعامل بعد الإقلاع يبقى مع WorkManager.
- device readiness.
...
- transient vs conflict classification — **التصنيف منفَّذ**
  على الأمر وعلى الجلسة؛ عرض التعارض للمستخدم باقٍ.
