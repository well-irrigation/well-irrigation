...
## 25. Documentation Gate Validation — ق-97

في دفعات التوثيق يجب أن يسبق Commit فحص Contract
يتأكد من عناصر البوابة المنطبقة.

لا يلزم أن يفحص Shell معنى كل قرار آليًا، لكنه يفحص
Markers وبنية الملفات التي يمكن التحقق منها آليًا.

بعد Push وClean Worktree يمكن إخراج:

    DOCUMENTATION_GATE=PASS

فقط إذا لم يوجد Failure سابق.

إذا فشل فحص التوثيق:

- لا Commit إذا كان الفشل قبل Commit.
- لا انتقال للموضوع التالي.
- يستخدم Recovery وفق هذا البروتوكول.
