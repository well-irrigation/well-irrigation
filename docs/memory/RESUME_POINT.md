...
2. حماية فرع `main` في `GitHub` — صارت حاجة أمنية لا تنظيمية،
   لأن `main` موصول بقاعدة الإنتاج مباشرة عبر التكامل. وترقية
   الخطة إلى `Pro` لأجل النسخ الاحتياطي وفروع المعاينة.
