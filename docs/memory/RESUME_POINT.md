...
نناقش الترتيب التفصيلي لشاشة بدء الجلسة، بما يشمل:

- Smart Lookup للمزارع والأرض.
- إضافة مزارع أو أرض من نفس السياق.
- المضخة.
- مصدر الطاقة.
- السعر الظاهر.
- الدفعة المقدمة.
- رسائل المنع.
- الاتصال والعمل الميداني.

ق-88 وUX-08 موثقان، لكن متطلبات Backend الخاصة بهما
ليست منفذة بعد.
