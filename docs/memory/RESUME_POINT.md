...
نناقش ما يراه المالك فور وصوله إلى الرئيسية، وترتيب
الأقسام والإجراءات الأساسية، قبل تنفيذ أي واجهة فعلية.

صفحة التشغيل وصفحة الشريك ستناقشان كل واحدة على حدة
قبل التنفيذ.
