...
- لا تزال هناك متطلبات Backend ناتجة عن UX-02/03/08
  وق-84/ق-86/ق-88 غير منفذة؛ أول تغيير قاعدة جديد يجب
  أن يكون Migration 078+.
...
نناقش الشاشة التي تبين:

- حالة الجاهزية للعمل Offline.
- الصلاحيات والإعدادات الناقصة.
- آخر Sync ناجح.
- Pending commands.
...
ق-89 وUX-09 موثقان، لكن تنفيذ Mobile Offline Sync
وم-25 ما زالا Pending.
