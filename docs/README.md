...
- الهجرات المختومة لا تعدل، وأي DB change جديد يبدأ من الرقم التالي لها.
  **والسقف الحالي ورقم التالي في `AGENTS.md` §4 وحده** — لا يُكتب رقم هنا
  ولا في أي وثيقة تابعة، فالرقم المنسوخ يتقادم بلا أن يُلاحظ.
