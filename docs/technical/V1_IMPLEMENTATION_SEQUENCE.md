...
2. W1-02 وW1-03 مغلقتان؛ W1-03b مطبقة بق-113 /
   ...
   Migration 083+084؛ وW2-02a مطبقة بق-115 بلا أي تغيير على
...
**المتبقي في W2-02 — لم يبدأ:**

- **W2-02b:** WorkManager والإرسال بلا فتح التطبيق،
  والاستعادة بعد إقلاع الهاتف، وصلاحيات المانيفست.
- **W2-02c:** سجل الجلسة النشطة واستعادتها بعد موت العملية.
- **W2-02d:** Device Readiness وشاشات حالة المزامنة (ق-90 /
  UX-10).

**م-25 تضيق ثانيةً ولا تُغلق.**
