...
- ~~`_AllocateAdvanceDialog` في شاشة الحساب المالي للمزارع يرسل
  `paymentId: 'mock-advance-pay'`~~ — **أُغلق في 2026-09-02** (م-41D5):
  النافذة صارت `_AdvanceUnavailableDialog` بلا مستودع ولا زر تأكيد،
  وتعلن أن التسديد من الرصيد المقدَّم غير متاح وأن لا أمر أُرسل. الباقي
