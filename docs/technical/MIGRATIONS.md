...
**التحقق المحلي:** **معلَّق** — بانتظار `npm run db:reset` ثم
`npm run db:test` عند المالك. المتوقع: Target 093 = 15 PASS، والحزمة
**31 files / 500 PASS** (485 + 15) بلا تغيير في عدد تحققات 080/081
(الأرقام المتوقعة داخلها تغيّرت لا عددها).
