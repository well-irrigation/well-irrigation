...
`apps/mobile/lib/core/session/`؛ وبقية البنود تصميم ملزم
لم يُنفَّذ بعد.
...
2. Mobile offline synchronization:
   ...
   ما زال غير منفَّذ: الإرسال الخلفي بلا فتح التطبيق
   (WorkManager) وربط الجهاز وشاشات التعارض في Flutter.
...
- م-25: **ضُيِّقت ثلاث مرات ولم تُغلق** — بق-114 (تكرار الخادم)
  وق-115 (الطابور الدائم) وق-116 (الاستعادة بعد موت التطبيق).
  الباقي: الإرسال الخلفي بلا فتح التطبيق، وشاشات المزامنة.
...
W2-02b (WorkManager / الإرسال بلا فتح التطبيق) و
